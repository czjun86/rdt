...
.main{height:150px;background-color:#ffffff;box-shadow:-1px 2px 8px #d9d9d9}
	</style>
	<script>
					...
					<span class="gis_search" onClick="showOrhide()"><div class="map_contraction"></div></span>
						<div class="navbar navbar-default" id="titlediv" role="navigation">
							...
							<li class="text_name">指标:</li>
							          <li class="heat_7"><font  style="color:#000000;font-size:18px;">${(kpis.shape)!}</font>
							              <span style="font-size:11px;"> 无服务</span>
							               </li>
							               <li class="heat_1"><font  style="color:${(kpis.range_one_color)!};font-size:18px;">${(kpis.shape)!}</font>
							              ...
							              <#if kpis.range_one_state ?? && kpis.range_one_state==1>(${(kpis.range_one_start)!},${(kpis.range_one_end)!})</#if>
							               ...
							               <#if kpis.range_one_state ?? && kpis.range_one_state==4>[${(kpis.range_one_start)!},${(kpis.range_one_end)!})</#if></span>
											...
											<li class="heat_2"> <font style="color:${(kpis.range_two_color)!};font-size:18px;">${(kpis.shape)!}</font>
										  <span style="font-size:11px;"> 
										  <#if kpis.range_two_state ?? && kpis.range_two_state==1>(${(kpis.range_two_start)!},${(kpis.range_two_end)!})</#if>
							               ...
							               <#if kpis.range_two_state ?? && kpis.range_two_state==4>[${(kpis.range_two_start)!},${(kpis.range_two_end)!})</#if></span>
											...
											<li class="heat_3"><font  style="color:${(kpis.range_three_color)!};font-size:18px;">${(kpis.shape)!}</font>
										 <span style="font-size:11px;"> 
										  <#if kpis.range_three_state ?? && kpis.range_three_state==1>(${(kpis.range_three_start)!},${(kpis.range_three_end)!})</#if>
							               ...
							               <#if kpis.range_three_state ?? && kpis.range_three_state==4>[${(kpis.range_three_start)!},${(kpis.range_three_end)!})</#if></span>
											...
											<li class="heat_4"><font  style="color:${(kpis.range_four_color)!};font-size:18px;">${(kpis.shape)!}</font>
                                          <span style="font-size:11px;">
							               ...
							               <#if kpis.range_four_state ?? && kpis.range_four_state==4>[${(kpis.range_four_start)!},${(kpis.range_four_end)!})</#if></span>
											...
											<li class="heat_5"><font  style="color:${(kpis.range_five_color)!};font-size:18px;">${(kpis.shape)!}</font>
											<span style="font-size:11px;">
							               ...
							               <#if kpis.range_five_state ?? && kpis.range_five_state==4>[${(kpis.range_five_start)!},${(kpis.range_five_end)!})</#if></span>
											...
											<li class="heat_6"><font  style="color:${(kpis.range_six_color)!};font-size:18px;">${(kpis.shape)!}</font>
	                                      <span style="font-size:11px;"> 
							...
							<div  class="navbar-form navbar-left breadcrumb" style="margin-bottom: 0px;">
								<!--时间范围控件       开始-->
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<select class="form-control input-small select2me kpi_v" style="width: 130px !important;" name="kpiType" id="kpiType">
									...
									&nbsp;
									<select class="form-control input-small select2me" style="width: 60px !important;margin-left:-5px;" name="kpiSymbol" id="kpiSymbol">
									...
									&nbsp;                                   
									<input name="kpiVaule" type="text" class="form-control " style="width:100px;margin-left:-5px;" id="kpiVaule" maxlength="8" value="${(kpiVaule)!}" placeholder="请输入指标值">
						     	</div>
						     	<div class="form-group" style="margin-left:8px;">
									<label class="control-label" >事件:</label>
									<select class="form-control input-small select2me" style="width:120px !important;" name="warn" id="warn" placeholder="事件选择">
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<input class="form-control" type="text" id="imei" name="imei" style="width:160px !important;" placeholder="请输入IMEI"/>
								</div>
					     </br>
							<!--区域  开始-->
								<div class="form-group">
									...
									&nbsp;
									<select class="fform-control input-small select2me" <#if user?? && user.district?? && user.district=='-1'>hasAreaAll="1"</#if> style="width:88px !important;margin-left:-5px;" name="district" id="district">
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<select class="form-control input-small select2me" style="width: 127px !important;" name="roadType" id="roadType">
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<select class="fform-control input-small select2me" style="width:130px !important;" name="roadLevel" id="roadLevel">
						...
						<div clss="bigmain" id="bigmain" style="top:220px;width: 30%;position:absolute;right:15px;z-index:999;">
							<div id="kpi_0" class="main" style="display:none"></div>
							<div id="kpi_1" class="main" style="display:none"></div>	
							<div id="kpi_2" class="main" style="display:none"></div>	
							<div id="kpi_3" class="main" style="display:none"></div>		
						</div>
						<!--
                        <div class="gis-mapgj">
							 	<input type="checkbox" name="kpi_contrast" value="0" checked ='checked'>RSRP		
							 	<input type="checkbox" name="kpi_contrast" value="1" checked ='checked'>SNR	
							 	<input type="checkbox" name="kpi_contrast" value="2" checked ='checked'>下行	
							 	<input type="checkbox" name="kpi_contrast" value="3" checked ='checked'>延时	
							  <div id="m_1" class="gis-mapgj-marquee" title="上一步"><img src="${application.getContextPath()}/images/drawing2.png"></div>
		  		              <div id="m_2" class="gis-mapgj-circle" title="下一步"><img src="${application.getContextPath()}/images/drawing2.png"></div>
							 ...
							 <div class="map_float_left">
							  <div class="map_input">
							<input class="cbt" name="kpi_contrast"  type="checkbox" value="0" checked ='checked'>

							<span>RSRP</span> </div>
							  <div class="map_input">
							<input class="cbt" name="kpi_contrast"  type="checkbox" value="1" checked ='checked'>

							<span>SNR</span></div>
							
							  <div class="map_input">
							<input class="cbt" name="kpi_contrast"  type="checkbox" value="2" checked ='checked'>
							<span>下行</span></div>
							
							  <div class="map_input">
							<input class="cbt" name="kpi_contrast"  type="checkbox" value="3" checked ='checked'>
							<span>延时</span></div>  
							
							  <div class="map_input" id="m_2">
							<div class="rorward"></div>
							<span style="margin:2px 4px 0 8px"></span></div>
							
                            <div class="map_input" id="m_1">
							<div class="rorward back_off"></div>
							<span style="margin:2px 4px 0 8px"></span></div>
							</div>
							</div>
...
<script src="${application.getContextPath()}/js/mapManager/TextIconOverlay_min.js" type="text/javascript"></script>
 ...
 <script src="${application.getContextPath()}/js/mapManager/mapStyle.js" type="text/javascript"></script>
  <script src="${application.getContextPath()}/js/mapManager/queryShow.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/playback/draws.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/playback/echarTools.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/playback/report.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/playback/grid.js" type="text/javascript"></script>
    <script src="${application.getContextPath()}/js/mapManager/playback/data.js" type="text/javascript"></script>
	</body>
<!-- END BODY -->
</html>