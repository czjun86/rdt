						...
						<!--颜色说明-->
							...
							<!--区域  开始-->
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<input class="form-control autocomplete_road" nonull="1" name="roadName" value="${(vo.roadName)!''}" id="roadName" placeholder="全部" style="width:160px !important;" onclick="$('#roadName').autocomplete('search', document.getElementById('roadName') );"/>
