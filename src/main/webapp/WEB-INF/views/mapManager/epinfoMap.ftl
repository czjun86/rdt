						...
						<!--颜色说明-->
							...
							<div  class="navbar-form navbar-left breadcrumb" >
								...
								<div class="form-group" style="margin-left:8px;">
									...
									&nbsp;
									<select class="form-control input-small select2me" style="width: 50px !important;margin-left:-5px;" name="kpiSymbol" id="kpiSymbol">
									...
									&nbsp;                                   
									<input name="kpiVaule" type="text" class="form-control " style="width:60px;margin-left:-5px;" id="kpiVaule" maxlength="8" value="${(kpiVaule)!}" placeholder="请输入指标值">
						     	</div>
						     	<div class="form-group" style="margin-left:8px;">
									<label class="control-label" >事件:</label>
									<select class="form-control input-small select2me" style="width:140px !important;" name="warn" id="warn" placeholder="事件选择">
								...
								<div class="form-group" style="margin-left:8px;">
									...
									<input class="form-control" type="text" id="imei" name="imei" value="${(vo.imei)!}" style="width:160px !important;" placeholder="请输入IMEI"/>
								</div>
					     </br>
							<!--区域  开始-->
								<div class="form-group">
						...
						<input id="uuid" style="display:none" value=""/>
                          <div class="map_float">
									<div class="map_float_left">
									 <ul>
									<li id="h_3" class="left_img1"><span>|</span></li>
									<li id="h_2" class="left_img2"><span>|</span></li>
									<li id="h_1" class="left_img3"></li>
									 </ul>
									</div>
					</div>		
						<!--地图-->
...
<!-- BEGIN FOOTER -->
	...
	<!--页面工具脚本-->
	   ...
	   <script src="${application.getContextPath()}/js/mapManager/epinfoMap/map.js" type="text/javascript"></script>
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=byh1tKOFFXcgzqTYGkj5mWWp"></script>
<script type="text/javascript" src="${application.getContextPath()}/js/mapManager/epinfoMap/DrawingManager_min.js"></script>
<script type="text/javascript" src="${application.getContextPath()}/js/mapManager/epinfoMap/AreaRestriction_min.js"></script>
<script src="${application.getContextPath()}/js/mapManager/epinfoMap/MarkerClusterer.min.js" type="text/javascript"></script>
<script src="${application.getContextPath()}/js/mapManager/epinfoMap/TextIconOverlay_min.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/mapStyle.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/epinfoMap/draws.js" type="text/javascript"></script>
	<script src="${application.getContextPath()}/js/mapManager/epinfoMap/grid.js" type="text/javascript"></script>
	 <script src="${application.getContextPath()}/js/mapManager/queryShow.js" type="text/javascript"></script>
    <script src="${application.getContextPath()}/js/mapManager/epinfoMap/data.js" type="text/javascript"></script>
	...
	<script src="${application.getContextPath()}/js/mapManager/epinfoMap/pline.js" type="text/javascript"></script>
	
	<script src="${application.getContextPath()}/js/mapManager/epinfoMap/mapReport.js" type="text/javascript"></script>-->
