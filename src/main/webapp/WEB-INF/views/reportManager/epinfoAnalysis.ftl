...
<body class="page-header-fixed">
					...
					<!-- title-->
						<div class="portlet ">
							<div class="portlet-body">
								...
								<div class="navbar navbar-default" role="navigation" style="background:#fff !important;">
									<form class="navbar-form form-inline navbar-left breadcrumb" id="validateHealthDegree" role="search" method="post" onsubmit="return false;">
										...
										<div class="form-group"  style="margin-left:85px;">
											...
											<input class="form-control" type="text" id="imei" name="imei" style="width:165px !important;" maxlength="20" value="${(queryBean.imei)!}"/>
										</div>
										<!-- imei 开始 -->
										<!--<div class="form-group"  style="margin-left:8px;">
								...
								<!-- 查询条件 -->
								<form id="pageForm" name="pageForm" action="${application.getContextPath()}/epinfoAnalysis/query" method="post">
									...
									<!-- IMEI -->
									<input type="hidden" id="imei_page" name="imei" value="${(queryBean.imei)!}"/>
									<!-- 下行宽带占比阀值 -->
								...
								<!-- 跳转地图查询条件 开始 -->
								<form id="linkMap" name="linkMap" action="${application.getContextPath()}/epinfoMap/map?op_menu=9" method="post" >
									...
									<input type="hidden" id="roadName_map" name="roadName"/>
									<!-- IMEI -->
									<input type="hidden" id="imei_map" name="imei" value="${(queryBean.imei)!}"/>
									<!--时间-->
										...
										<tbody>
											<#if page?? && page.list?? &&  page.list?size &gt; 0>
												<#list page.list as ls>
													...
													st="${(ls.start_time)!'-'}" ed="${(ls.end_time)!'-'}" title="双击跳转终端GIS展现"
	...
	<!--查询条件-->
	<script type="text/javascript" src="${application.getContextPath()}/js/report/epinfo.js"></script>
	<!-- 右键菜单 -->
...
<div id="rightMenu" class="rightMenu" style="display:none;">
	<div class="gis-kuangxuan-close"id="linkRow">跳转终端GIS展现</div>
</div>
</html>