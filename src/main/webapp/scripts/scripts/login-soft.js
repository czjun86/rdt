var Login = function () {
	...
	var handleLogin = function() {
		$('.login-form').validate({
	            ...
	            invalidHandler: function (event, validator) { //在Submit之前，且验证失败。
	            	//$('.alert-danger', $('.login-form')).show();
	            },

	            highlight: function (element) { //给未通过验证的元素加效果例如闪烁
	                $(element)
	                    .closest('.form-group').addClass('has-error'); 
	            },

	            success: function (label) {//单项验证成功例如用户名验证成功则去除用户名不能为空的提示
	...
	var handleRegister = function () {
		...
		function format(state) {
            ...
            return "<img class='flag' src='scripts/img/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
    ...
    return {
        ...
        init: function () {
            ...
            handleRegister();        
	       	...
	       	$.backstretch([
		        "scripts/img/bg/1.jpg",
		        "scripts/img/bg/2.jpg",
		        "scripts/img/bg/3.jpg",
		        "scripts/img/bg/4.jpg"
		        ], {
		          fade: 1000,
		          duration: 8000
		    });
